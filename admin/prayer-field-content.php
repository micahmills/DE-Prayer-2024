...
//            $day = DT_Campaign_Fuel::what_day_in_campaign( $post_date );
    ...
    public static function content( $language, $names, $from_translation = 'en_US' ) {
        ...
        $data = [
            //day 1
            [
                __( 'In Islam God has 99 names–such as All-Merciful, The Beneficent, The Source of Peace–but none of those names is Love. Father God, who reveals yourself as the God of Love throughout the Bible, please reveal yourself to Muslims [in location] with your true nature.', 'de-prayer-2024' ),
...
Pray for Christians from a Muslim background [in location] to overcome rejection they have experienced through the love God showed us on the cross of Christ.', 'de-prayer-2024' ),
...
Ask that the joy of Jesus would fill believers’ hearts as they remain in His love by obeying His commandments.', 'de-prayer-2024' ),
            ],
            //day 2
            [
                __( 'In Islam, it is a sin to doubt. It leaves many Muslims with fear of eternal damnation if they question anything they have been taught about religion. Pray today for Muslims [in location] to seek the true God who is big enough for our questions and doubts.', 'de-prayer-2024' ),
...
Pray for Christ followers [in location] to renounce intimidation from the Muslim society around them and to put trust in God.', 'de-prayer-2024' ),
...
Believers must engage lostness on a daily basis, sharing boldly and broadly everything they’re learning from God. Ask that workers would make disciples and not just converts. Intercede for emerging church communities to start new groups. Pray for new communities of faith to quickly be baptized.', 'de-prayer-2024' ),
                __( 'Pray that Christians around the country will have one unified vision of reaching their country.', 'de-prayer-2024' ),
...
Pray for Christians from a Muslim background [in location] to live in the reality that their blood price has been paid in Christ and to honor God with their bodies.', 'de-prayer-2024' ),
...
Ask for grace to share every day and to ceaselessly preach the truth.', 'de-prayer-2024' ),
                __( 'Pray that Christians [in location] will search out unreached peoples around them which have not yet been touched by the Gospel. Pray for God to send harvesters to these other groups.', 'de-prayer-2024' ),
...
Amen.', 'de-prayer-2024' ),
            ...
            //day 5
            [
                __( 'There are many teachings in Islam that allow for murder, enslavement, rape, and abuse of women. Today we pray for both men and women [in location] to see the value of women, who are created by God as His image bearers as well.', 'de-prayer-2024' ),
...
Pray for Christians from a Muslim background [in location] to renounce every way they have believed lies that men and women are not equal before God.', 'de-prayer-2024' ),
...
Create powerful encounters with You, the living God.', 'de-prayer-2024' ),
                __( 'Pray that God would free all those following Christ – new and mature believers [of location] – of the spiritual bondage of the past.', 'de-prayer-2024' ),
                __( 'Lord, you did it then, and you can do it now. You are the God of dreams and visions. Lord we pray in one voice that you would visit our Muslim brothers and sisters in the night through dreams. And we pray, too, that you would visit them during the day in open visions. We believe your heart is for movement breakthrough, so let your Kingdom come and your will be done here [in location] as in heaven.', 'de-prayer-2024' ),
            ],
            //day 6
            [
...
Pray for new Christ followers [in location] to renounce inferiority and glory in Christ\'s triumph over death through the cross.', 'de-prayer-2024' ),
...
Pray for a release of the spirit of love over and against the spirits of death and destruction.', 'de-prayer-2024' ),
                __( 'Pray for Christians [in location] to grow daily in the Word.', 'de-prayer-2024' ),
...
Pray for Christians from a Muslim background [in location] to trust only the Holy Spirit to reveal truth.', 'de-prayer-2024' ),
...
Pray that principalities and powers over [location] would be held back, broken, and thrown down as the name of Jesus is lifted high over this nation. May we declare prophetic words over [location], releasing visions, dreams, signs, and wonders in Jesus’ name. And may followers of Jesus walk in the authority bestowed on them by Christ’s life, death, resurrection, and ascension.', 'de-prayer-2024' ),
                __( 'Pray that Christians [in location] will have a heart to start new churches among their friends and family.', 'de-prayer-2024' ),
...
“Our hope is that, as your faith continues to grow, our area of activity among you will greatly expand, so that we can preach the gospel in the regions beyond you” (2 Co 10:15-16).', 'de-prayer-2024' ),
            ],
            //day 8
            [
                __( 'The primary way Islam is growing globally is through birth rate. The primary way Christianity is growing globally is through movements of the Gospel. Pray for these movements to flow through [location] and all Muslim lands.', 'de-prayer-2024' ),
...
Pray for Christians from a Muslim background [in location] to overcome shame from their past, family, or society by looking to Jesus, the author and perfecter of our faith.', 'de-prayer-2024' ),
...
Today, we claim this promise originally spoken over Jerusalem. Lord, we declare: the time will come when You will heal the wounds [of location], You alone can heal them. And we speak in faith over [location]: Lord, You and You alone will bring true peace and prosperity.', 'de-prayer-2024' ),
                __( 'Pray that life\'s difficulties will not distract believers [in location] from God\'s purpose for their lives.', 'de-prayer-2024' ),
                __( 'Ask that God’s word would spread rapidly throughout [location], being honored wherever the word of God is shared. Pray that a sense of urgency would come upon believers, old and new alike, to share this gospel of the Kingdom with all. As the Samaritan woman in John 4 quickly shared with her village and introduced them to Jesus; Lord, may new people of peace spread your gospel message to new communities now, during this month, during Ramadan.', 'de-prayer-2024' ),
            ],
            //day 9
            [
                __( 'There is a hadith (teaching) in Islam that says, "Be good to your mother, Paradise is under her feet." This positive teaching is often negatively used to prevent Muslims from questioning or rejecting the religion of their parents. Today, we pray for Muslims [in location] to have courage from God to honor their parents, but not blindly follow their religion and to instead pursue Truth.', 'de-prayer-2024' ),
...
Pray for Christians from a Muslim background [in location] to renounce lies that they cannot question or investigate spiritual matters.', 'de-prayer-2024' ),
...
Ask for God’s Spirit to respond to those like the Centurion who are genuinely seeking Him.', 'de-prayer-2024' ),
                __( 'Pray that God will raise up Christian leaders out of each region or state [in location].', 'de-prayer-2024' ),
                __( 'You are the God of dreams and visions. Lord, we pray that you would visit our Muslim brothers and sisters in the night in dreams. And we pray, too, that you would visit them during the day in open visions. Release hope. Release peace. Release revelation of Christ in the hearts of the people [of location].', 'de-prayer-2024' ),
            ],
            //day 10
            [
                __( 'Islam pursues political, societal, and top-down power structures. Christianity teaches bottom-up servant leadership (Luke 22:25-27). Pray for [location] to be transformed as Christians model Christian leadership principles and reject worldly power structures.', 'de-prayer-2024' ),
...
Pray for those following Jesus [in location] to speak about Christ with boldness.', 'de-prayer-2024' ),
...
Lord, we declare on behalf of the refugees from [location]: Defend their cause; you care about their plight; you respond to their cries for justice; and you reach down from heaven to act. You are the God of the refugee, a safe haven, a strong tower. And you stand with those whose backs are up against the wall.', 'de-prayer-2024' ),
                __( 'Pray that the Bible will be translated into the heart language of every people [in location]. Pray for the illiterate to have access to an audio version.', 'de-prayer-2024' ),
...
When they live and love, surround them at all times by your confirming, world-changing power.', 'de-prayer-2024' ),
            ],
            //day 11
            [
                __( 'The Islamic doctrine of abrogation means that some verses in the Quran can be "canceled out" by later verses. This is contrary to the unchanging nature of God in the Bible. "Because God wanted to make the unchanging nature of his purpose very clear to the heirs of what was promised, he confirmed it with an oath. God did this so that, by two unchangeable things in which it is impossible for God to lie, we who have fled to take hold of the hope offered to us may be greatly encouraged. We have this hope as an anchor for the soul, firm and secure…" (Hebrews 6:17–19) Today we pray for people [in location] to see the unchanging nature of God, that it is impossible for him to lie, and to make him the anchor for their souls.', 'de-prayer-2024' ),
...
Pray for Christians from a Muslim background [in location] to find their confidence in the truth of the Bible and all that it says about Christ.', 'de-prayer-2024' ),
...
Ask boldly that all areas [of location] would hear the word of the Lord.', 'de-prayer-2024' ),
                __( 'Pray for every effort of ministry and service done [in location] to be motivated by God\'s love for us, and our love for God (James 1:12, 2:5, Revelation 2:4).', 'de-prayer-2024' ),
...
Father! Complete them. Perfect them. Sanctify them. Do abundantly more in their hearts and minds than we could ever ask or dare to imagine, for they are your masterpiece! You have set them apart for special works [in location] that will bring You glory.', 'de-prayer-2024' ),
            ],
            //day 12
            [
                __( 'Muslims believe that the Quran is the perfect and final revelation of God. Christians believe that Jesus is. "He is the radiance of the glory of God and the exact imprint of his nature..." (Hebrews 1:1-4). Pray for Muslims [in location] to read the Gospels and see the contrast between the exact representation of God\'s nature we see in Christ and what the Quran teaches.', 'de-prayer-2024' ),
...
Pray for Christians from a Muslim background [in location] to put on the armor of God and recognize their battle is not against flesh and blood but against spiritual forces.', 'de-prayer-2024' ),
...
Ask for the gift of reproducibility: in evangelism, in discipleship, and in church structures.', 'de-prayer-2024' ),
                __( 'Pray that the church [in location] will be super clear: 1) that God wants to save the lost (through the Gospel) 2) that God wants the lost to become like Christ (through the church).', 'de-prayer-2024' ),
...
Pray for those following Christ [in location] to renounce the lie that suffering for the sake of Christ is shameful.', 'de-prayer-2024' ),
...
Pray that God would respond to the prayers [of location] and that he send blessings on them.', 'de-prayer-2024' ),
                __( 'Pray for wisdom about if/where Christians [in location] should use money in the emerging discipling network so that the movement ends up being healthy.', 'de-prayer-2024' ),
...
Pray for believers, especially those from a Muslim background, [in location] to be drawn to Jesus and repent of fear that comes from the prince of this world.', 'de-prayer-2024' ),
...
Ask Him for new spiritual authority and power to be released as movement practitioners fast and pray.', 'de-prayer-2024' ),
                __( 'Pray for intentional, generous, and effective sharing between near culture ministries that are pursuing and progressing toward movement.', 'de-prayer-2024' ),
                __( 'Oh Jesus! Help your apprentices [in location] be more like you, living with a sense of purpose and urgency to preach the Good News in still other places. Give us the grace to share your Gospel daily. Keep us, Lord, from being bogged down by busyness and programs that you’re not asking us to steward. Liberate our time, our attention, and our energy so that we –like you – would proclaim the Good News of the Kingdom in all communities throughout [location].', 'de-prayer-2024' ),
            ],
            //day 15
            [
                __( 'Zakat, one of the five pillars of Islam, requires Muslims to donate a set percentage of their wealth each year to Muslim charities. The New Testament teaches Christians to give generously from the heart as opposed to a set percentage. Pray for the people [of location] to be challenged by the contrast between a religious rule and a heart posture and to want to understand more about the "new heart" that the Bible teaches about (Ezekiel 36:26).', 'de-prayer-2024' ),
                __( 'We are called to walk in the light and live in truth:
"But whoever lives by the truth comes into the light, so that it may be seen plainly that what he has done has been done through God" (John 3:21).

Pray for all Christians [in location], particularly those from a Muslim background, to live in truth and for all of their relationships to be marked by truthfulness.', 'de-prayer-2024' ),
...
Ask for believers in the emerging movements to have the unabashed persistence of the widow in asking, seeking, and knocking.', 'de-prayer-2024' ),
                __( 'Pray for dreams that will compel people to seek their meaning. Pray for whole families, groups, and communities to have the same dream about Jesus.', 'de-prayer-2024' ),
...
"God is not a man, that he should lie, nor a son of man, that he should change his mind. Does he speak and then not act? Does he promise and not fulfill?" (Numbers 23:19).', 'de-prayer-2024' ),
...
Pray that God’s presence with believers [in location] would draw men and women to the true King.', 'de-prayer-2024' ),
                __( 'Pray that Christians [in location] will have vision and urgency to see all parts of their country reached with the gospel.', 'de-prayer-2024' ),
...
Lord, make Christians [in location] more like Paul, who poured out his life like a drink offering, who labored and toiled for his spiritual children. Give them the grace that was on his life to establish self-sustaining gospel communities. And Lord, as leaders of emerging movements imitate Christ, allow new facilitators and new leaders to imitate them. In this way, Lord, may your church sustain itself: disciples making disciples, leaders raising up leaders, groups starting groups, and churches planting churches.', 'de-prayer-2024' ),
            ],
            //day 17
            [
                __( 'Muslims acknowledge Jesus as a prophet from God. Let their curiosity be sparked in this season for them to learn all that Jesus says about Himself. Specifically, that He is “the way, the truth, and the life” (John 14:6) so that they may acknowledge Him as Lord and Savior.', 'de-prayer-2024' ),
...
Pray for Christians from a Muslim background [in location] to repent of every form of deception and walk in God\'s truth in all relationships.', 'de-prayer-2024' ),
                __( '“Let [location] praise you, O God; let all the peoples praise you!” (Psalm 67:3).

Lord, may all [location] praise you; may they praise you from every class and sect, from every religious and educational background; may they praise you in the cities and praise you in the villages, may they praise you from the seaside and praise you atop the highest peaks. You alone are worthy to receive glory and honor and praise, Great High King, rightful Ruler [of location].', 'de-prayer-2024' ),
                __( 'Pray for faith, not fear, to be what controls Christians [in location].', 'de-prayer-2024' ),
...
Declare the victory of Jesus over every spiritual enemy [in location].', 'de-prayer-2024' ),
            ],
            //day 18
            [
                __( 'Muslims pray prescribed prayers five times a day. Lord, as people from [location] turn to Christ, teach them how to keep spiritual rhythms, turning it into an intimate time with you and not simply a ritual. ', 'de-prayer-2024' ),
...
Pray for Christians from a Muslim background [in location] to grow each day in worshiping God in spirit and in truth.', 'de-prayer-2024' ),
                __( '“You are the God who works wonders; you have made known your might among the people [of location]” (Psalm 77:14).

O Lord, Sovereign over [location]! We come to you today, again, to sing your praise and declare your worth. You are worthy! You alone work wonders! You are the miracle maker, the Creator God, the One by whom all things came into being and through whom all life is sustained. Lord, demonstrate your might and power [in location]. Truly, You alone are God.', 'de-prayer-2024' ),
                __( 'Pray for great clarity (even generational maps that highlight key issues: https://zume.training/generational-mapping/) about areas where Christians [in location] may be distracted or deceived, making their work for the Lord just busyness and not genuinely fruitful.', 'de-prayer-2024' ),
...
Amen', 'de-prayer-2024' ),
            ...
            //day 19
            [
                __( 'Islam teaches an emotional worldview that Muslims are superior to non-Muslims. Lord, help believers [in location] shed the sins that so easily entangle them and instead put on their "new self" finding their value comes from You. ', 'de-prayer-2024' ),
                __( 'Lord help new followers of Christ [in location] renounce attitudes that place people in positions of superiority or inferiority. Let them, instead, follow Jesus’ humble example in Philippians 2:5-11, "Your attitude should be the same as that of Christ Jesus: Who, being in very nature God, did not consider equality with God something to be grasped, but made himself nothing, taking the very nature of a servant, being made in human likeness..."', 'de-prayer-2024' ),
...
Pray that God, in His mercy, would liberate the time, attention, and energy of the people [of location] for His purposes in His Kingdom.', 'de-prayer-2024' ),
                __( 'Pray for Christians to meet needs, preferably supernaturally through the Lord, and that their family members and friends would be witnesses of God\'s provision.', 'de-prayer-2024' ),
...
Pray for Christians from a Muslim background [in location] to cancel the power of and renounce every lie they\'ve heard that Jesus didn\'t die on the cross and to rejoice that they have been made alive with Christ through the cross.', 'de-prayer-2024' ),
...
God of Abraham, Isaac, and Jacob: we call on you to have mercy on [location], according to your word. And we declare: no more would you abandon this nation than you would change the laws governing night and day, earth and sky.', 'de-prayer-2024' ),
                __( 'Time is a precious commodity. Some people [in location] work or study long hours. Pray that God will give them wisdom to prioritize their time to serve Him.', 'de-prayer-2024' ),
...
Amen', 'de-prayer-2024' ),
            ...
            //day 21
            [
                __( 'Islam teaches that God is unknowable and as a result many feel like God is distant. We know the truth is that God Almighty wants an intimate relationship with His followers because He is a good Father who knows the hairs on our head (Luke 12:7). Lord, let all new followers of Christ [in location] be filled with joy at knowing the intimacy of God, who calls us "beloved".', 'de-prayer-2024' ),
...
Pray for Christians from a Muslim background [in location] to stand firm in Christ and reject the yoke of slavery to salvation through works.', 'de-prayer-2024' ),
                __( 'Jer 2:11, 13
...
Pray for a divine return to the fountain of living water, who is Christ.', 'de-prayer-2024' ),
                __( 'Often it is hard to find places for believers to meet because the rest of their families are not believers and will not allow it. Pray for places to meet and study the Bible and pray.', 'de-prayer-2024' ),
...
Lord, with one phrase–‘Lazarus! Come forth!’—you raised a dead man; and with one phrase–‘Come, O breath, breathe into these dead bodies that they may live again’–you raised a dead nation; you reconstituted them into an army: the forces of Yahweh. And today, we join in accord with your Word: [location], live! Receive the breath of the Lord, the Spirit of the triune God. Be raised to life. Return and live. Be dead no longer; slumber no longer; be sick no more. Return to Life, [location], and live!', 'de-prayer-2024' ),
            ...
            //day 22
            [
                __( 'Today many Christians celebrate Easter: the resurrection of Jesus from the grave. Muslims deny this fact. "And if Christ has not been raised, your faith is futile and you are still in your sins" (1 Corinthians 15:17). Pray for Muslims [in location] to be convicted of the reality that they are still in their sins and that only God Himself can provide a solution for that – the cross of Christ.', 'de-prayer-2024' ),
...
Pray for Christians from a Muslim background [in location] to overcome fear of rejection by identifying with the great love God showed them in sending his Son to give them eternal life.', 'de-prayer-2024' ),
...
Amen', 'de-prayer-2024' ),
                __( 'Pray that every man, woman, and child [in location] will hear the testimony of someone from his/her culture in-person.', 'de-prayer-2024' ),
...
Pray for all Christians, new and mature, from a Muslim background [in location] to trust only the Holy Spirit to guide them into all truth and to obey whatever he says.', 'de-prayer-2024' ),
...
Ask that God’s spirit would help people honor one another and delight in one another.', 'de-prayer-2024' ),
                __( 'Sometimes, as Christians, we are frozen by fear. Fear of persecution. Fear of rejection. Fear of losing something dear to us. Pray that God will give boldness and joy to Christians [in location] as they ponder what God has done in their own lives.', 'de-prayer-2024' ),
...
Pray for Christians from a Muslim background [in location] to speak with boldness about the insights they are gaining from the Holy Spirit about the truth of who Jesus is.', 'de-prayer-2024' ),
...
Pray for followers of Jesus in the Muslim community [of location] to take captive every thought to make it obedient to Christ and to take confidence in the spiritual weapons we have to demolish arguments against him.', 'de-prayer-2024' ),
...
Pray for Christians from a Muslim background [in location] to renounce fear and every form of slavery to it.', 'de-prayer-2024' ),
...
Ask that the reward for sowing to the Spirit would be gratifying and convincing, especially for our new believing brothers and sisters.', 'de-prayer-2024' ),
...
Declare that this year is the year of the Lord’s favor, that this month is the month of repentance, that this month is when God’s Kingdom is at hand.', 'de-prayer-2024' ),
...
Lord, soften hearts. Let those with ears to hear, let them hear. Give all those whom you are wooing the courage to repent and follow you.', 'de-prayer-2024' ),
            ],
            //day 27
            [
                __( 'On or around the 27th night of Ramadan, Muslims celebrate the "Night of Power" as a special time that their prayers and good deeds count for more. They believe their chance of getting their prayers answered and miracles done are increased on this night. Pray for multitudes of Muslims from [location] to encounter Jesus tonight in a dream or vision.', 'de-prayer-2024' ),
                __( 'Jesus is full of truth:
"We have seen his glory, the glory of the One and Only, who came from the Father, full of grace and truth" (John 1:14).

Pray for Christians from a Muslim background [in location] to model Jesus to those around them and to daily grow in being full of grace and truth.', 'de-prayer-2024' ),
...
We declare today that the people [of location] are destined to worship you and obey you, to love you and to enjoy you, forever. Lord, we ask that all the sects, tribes, and families [of location] shall remember you and turn to you; every knee will bow, and every tongue will confess that Christ is the Lord.', 'de-prayer-2024' ),
                __( 'Pray that Christians [in location] will recognize the specific spiritual gifts that God has given them and wisely use those to serve.', 'de-prayer-2024' ),
...
Amen', 'de-prayer-2024' ),
                __( 'When Christians [in location] look to the West they see large buildings and programming. But what is the essence of the church? What is its function? Pray that Christians will look to the Word of God as they start house churches, and not be overwhelmed by extra-biblical expectations.', 'de-prayer-2024' ),
                __( 'Ask that Jesus, the Lord of the Harvest, would release more workers into his fields [in location]. And pray that these workers would come from the harvest. We need more workers [in location]. Pray that workers from the same background as the harvest would be sent into the fields to sow and to reap, and ask that laughter would be granted to the sower as well as great joy for the reaper. Amen!', 'de-prayer-2024' ),
            ],
            //day 29
            [
                __( 'In many parts of the Muslim world, Islam is passed down more through tradition, family, and society than in formal education. Prayer, fasting, and going on the Hajj are mostly done in a communal context. Today we pray in faith for our brothers and sisters [in location] to find community and family in your Church. We pray they would have vision for sharing what they are learning about Christ in their community, families, and networks. ', 'de-prayer-2024' ),
...
Pray for Christians from a Muslim background [in location] to be freed from every need to self-promote, boast, and compensate for any sense of inferiority. May they embrace Jesus\' example of self-denial and follow Him.', 'de-prayer-2024' ),
...
Father, this scripture speaks truth: one day, [location] will sing the song of Moses, the song of Miriam (Exodus 15:20-21), and they shall dance before the Lord as a once-captive people now walking across a dry sea, a once-imprisoned people now liberated from the brutality of Pharaoh. The truth is that all the people [of location] shall sing: great and marvelous are your deeds, Lord God Almighty; just and true are your ways, O Lord, King of Ages!', 'de-prayer-2024' ),
                __( 'Christians are often persecuted by friends and family. Sometimes they have a hard time finding people who are willing to learn and grow with them. Pray that God will guide new believers [in location] to those they already know who are searching.', 'de-prayer-2024' ),
                __( 'Lord of compassion, would you rise and deliver your imprisoned people. Have mercy on those whose attention is captured by distractions and cheap thrills; have mercy on those whose time is consumed by workaholism and mindless activity; have mercy on those whose energy is sapped by the toxic effects of addiction, over-consumption, and escapism. Lord, have mercy; Christ, have mercy.', 'de-prayer-2024' ),
            ],
            //day 30
            [
                __( 'Thank the Lord for the love He has given you for the people [of location] as you prayed for them to encounter Christ this Ramadan. Pray for Him to complete the good work he has begun [in location]. Take time to listen to next steps God would have you take on behalf of the people [of location].', 'de-prayer-2024' ),
...
Pray for Christians from a Muslim background [in location] to experience complete unity with God and other Christians as Jesus prayed in John 17.', 'de-prayer-2024' ),
...
Lord, on this last day of Ramadan, we cry out to you again and declare the truth of your promise that this Gospel of Your Kingdom shall be preached throughout the entire Muslim world: from Morocco to Indonesia, from California to the streets of Paris. And [in location], again, we proclaim: North and South, East and West; mountain, coast, and valley; every family, village, town, region, and city [in location] shall hear the truth of the Gospel of Christ.', 'de-prayer-2024' ),
                __( 'Pray for existing groups (friends, co-workers, families, etc.) to yearn to discover, obey, and share God\'s Word. When this happens with existing groups there are far fewer obstacles and complexities in figuring how and where to meet.', 'de-prayer-2024' ),
