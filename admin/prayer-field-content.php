...
//            }
            ...
            $content[] = [
                ...
                'content' => [
                    ...
                    '<p class="has-small-font-size"><em>' . esc_html( ramadan_format_message( __( 'Each of us who comes to Christ must repent of and renounce every pact, promise, or identity we held before faith in Christ. Over the 30 days join us in praying for our brothers and sisters in Christ from a Muslim background as they repent of their former identity as Muslims. These prayers are inspired by chapter 7 and 8 of Liberty to the Captives by Mark Durie', 'ramadan-2024' ), $fields ) ) . '</em></p>',
                    '<!-- /wp:paragraph -->',
